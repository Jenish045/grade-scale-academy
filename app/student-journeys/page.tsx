...
export default function StudentJourneysPage() {
  ...
  return (
    <div className="bg-background min-h-screen pt-4">
      ...
      <Section id="journeys-faq" variant="standard" className="bg-rhythm py-[88px] lg:py-[112px] border-b border-[rgba(15,23,42,0.08)]">
      ...
      {/* SECTION 9: FINAL CTA BANNER (Centered Card) */}
      <Section id="journeys-final-cta" variant="standard" className="bg-white py-[88px] lg:py-[112px]">
